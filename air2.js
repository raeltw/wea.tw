function air1() {
   ...
   //return;
    ...
    // 重點!!!
    sendmsg('3darea', '正在從環保局 API 載入資料...'); // 假設你有一個 id 為 'api_dataa' 的元素來顯示數據

    fetch(_apiurl1) // 使用 fetch 呼叫 API
        .then(response => {
            console.log('HTTP 響應狀態：', response);
        ...
        .then(data => {
            ...
            // 260707 之前的某日 改果資料結構 records階層拿掉了
            let airLocations = data;
