...
/// move
               ...
               currentDataIndex3 = -1; 
                ...
                for (jj = 0; jj < _dt0.length; jj++) {
                 ...
                 //for (ii = 0; ii < _col0.length; ii++) {
                 //   sendmsg('3darea', _col0[ii]);
                 //}
                 //window.alert(_col0.length);
                 //return "";
...
// 260710 日期標籤變色（不預設顏色，僅特定星期變色）
                ((savedDt0) => {
                    setTimeout(() => {
                        const xAxisContainer = document.getElementById('xaxis3d');
                        if (xAxisContainer) {
                                        ...
                                        if (dateSpan) {
                                            ...
                                            if (dateText && dateText !== ' ') {
                                                ...
                                                if (dayOfWeek === 0) {
                                                    ...
                                                    dateSpan.style.color = '#00FF00'; // 週一、週四：青綠色
                                                }
                                            }
                                        }
                                    }
